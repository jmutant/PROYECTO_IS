...
public class LoginVentana extends JFrame implements LoginVista {
    ...
    private void construirInterfaz() {
        ...
        c.gridy = 0; c.insets = new Insets(4,0,4,0); panel.add(titulo,c);
        c.gridy = 1; panel.add(subtitulo,c);
        c.gridy = 2; c.insets = new Insets(20,0,2,0); panel.add(etiquetaUsuario,c);
        c.gridy = 3; c.insets = new Insets(2,0,4,0); panel.add(campoUsuario,c);
        c.gridy = 4; c.insets = new Insets(10,0,2,0); panel.add(etiquetaContrasena,c);
        c.gridy = 5; c.insets = new Insets(2,0,4,0); panel.add(campoContrasena,c);
        c.gridy = 6; c.insets = new Insets(10,0,4,0); panel.add(etiquetaError,c);
        ...
        c.gridy = 7; c.insets = new Insets(4,0,0,0); panel.add(botones,c);
